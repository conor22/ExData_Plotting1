...
## Create the 2 x 2 matrix 
png(filename="plot4.png", width=480, height=480, units="px")
par(mfrow = c(2,2))

## Create Global Active Power graph (top left)
plot(sub_power[,2], sub_power[,3], type = "l", ylab="Global Active Power", xlab="")

## Create Voltage graph (top right)
plot(sub_power[,2], sub_power[,5], type = "l", ylab="Voltage", xlab="datetime")

## Create Energy Sub Meterting graph (bottom left)
...
## Create Global reactive power graph (bottom right)
plot(sub_power[,2], sub_power[,4], type = "l", ylab="Global_reactive_power", xlab="datetime")
dev.off()